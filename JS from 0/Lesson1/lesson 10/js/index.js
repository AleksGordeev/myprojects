...
var testInner = document.getElementById('test-inner');
var loginButton = document.getElementById('login');



/*lastNameUserEl.value = 'Ivanovvvvv';
cityEl.value = 'Москва';*/
